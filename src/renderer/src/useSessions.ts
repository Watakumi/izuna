          ...
          prev.map((p) => {
            ...
            switch (event.kind) {
              ...
              case 'loopProgress':
                return {
                  ...p,
                  loop: { progress: event.progress, iteration: event.iteration, stop: null }
                }
              case 'loopStopped':
                return {
                  ...p,
                  ...
                  transcript: {
                    ...
                    items: [
                      ...
                      {
                        kind: 'notice',
                        id: `loop${p.transcript.items.length}`,
                ...
                return {
                  ...
                  transcript: {
                    ...
                    items: [
                      ...
                      {
                        kind: 'notice',
                        id: `wake${p.transcript.items.length}`,
                        tone: 'info',
                ...
                return {
                  ...
                  transcript: {
                    ...
                    items: [
                      ...
                      {
                        kind: 'notice',
                        id: `tm${p.transcript.items.length}`,
                        tone: 'info',
                ...
                return {
                  ...
                  transcript: {
                    ...
                    items: [
                      ...
                      {
                        kind: 'notice',
                        id: `e${p.transcript.items.length}`,
                        tone: 'bad',
                        text: event.message
                      }
                    ]
    ...
    async (
      ...
      setPanels((prev) => [
        ...prev,
        {
          ...
          branch: input.branch,
          team: input.team,
          transcript: prior ?? emptyTranscript(),
          pending: null,
          prompt: '',
          commands,
          ended: false,
      ...
      if (first) {
        setPanels((prev) =>
          prev.map((p) =>
            p.id === id ? { ...p, transcript: appendUserText(p.transcript, first, 'u0') } : p
          )
        )
